...
export interface ApiCampaignCampaign extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amountGoal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    amountRaised: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    content: Schema.Attribute.Blocks & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDonationDonation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    donor: Schema.Attribute.Relation<'manyToOne', 'api::donor.donor'>;
    interval: Schema.Attribute.Enumeration<['one-time', 'month', 'year']> &
      Schema.Attribute.Required &
    ...
    publishedAt: Schema.Attribute.DateTime;
    subscribeToUpdates: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDonorDonor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    campaign: Schema.Attribute.Relation<'manyToMany', 'api::campaign.campaign'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    donations: Schema.Attribute.Relation<'oneToMany', 'api::donation.donation'>;
...
export interface ApiSupportedCauseSupportedCause
  extends Struct.CollectionTypeSchema {
  collectionName: 'supported_causes';
  info: {
    description: '';
    displayName: 'SupportedCause';
    pluralName: 'supported-causes';
    singularName: 'supported-cause';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::supported-cause.supported-cause'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::supported-cause.supported-cause': ApiSupportedCauseSupportedCause;
